            ...
            <div>
                ...
                <div className="pt-5">
                    <div className="mb-6 grid gap-6 xl:grid-cols-3">
                        <div className="panel h-full xl:col-span-2">
                            <div className="mb-5 flex items-center justify-between dark:text-white-light">
                                <h5 className="text-lg font-semibold">Monthly Analysis of User Demographics</h5>
                            ...
                            <p className="text-lg dark:text-white-light/90">
                                Total Users <span className="ml-2 text-primary">10,840</span>
                            </p>
                        ...
                        <div className="panel h-full">
                            <div className="mb-5 flex items-center">
                                <h5 className="text-lg font-semibold dark:text-white-light">Age Group Distribution Among Users</h5>
                            </div>
                            <div>
                                <div className="rounded-lg bg-white dark:bg-black">
                                    {isMounted ? (
                    ...
                    <div className="mb-3 grid grid-cols-1 gap-6 lg:grid-cols-2">
                        <div className="panel h-full sm:col-span-2 xl:col-span-1">
                            <div className="mb-5 flex items-center">
                                <h5 className="text-lg font-semibold dark:text-white-light">
                                    Daily User Engagement: Average Time on App
                        ...
                        <div className="panel h-full">
                            <div className="mb-5 flex items-center justify-between dark:text-white-light">
                                <h5 className="text-lg font-semibold">Content Overview </h5>
                    ...
                    <div className="mb-6 grid gap-12 xl:grid-cols-3">
                        <div className="panel h-full xl:col-span-2">
                            ...
                            <PerfectScrollbar className="relative mb-4 h-[290px] ltr:-mr-3 ltr:pr-3 rtl:-ml-3 rtl:pl-3" options={{ suppressScrollX: true }}>
                                <div className="cursor-pointer text-sm">
                                    <div className="group relative flex items-center py-1.5">
                                        ...
                                        <div>
                                            <div>Flagged Posts Review:</div>
                                            <div className="mb-2 text-xs text-white-dark dark:text-gray-500">15 posts flagged for policy violations on 11/03/2024.</div>
                                        </div>
                                    ...
                                    <div className="group relative flex items-center py-1.5">
                                        ...
                                        <div>
                                            <div className="flex-1">User Growth:</div>
                                            <div className="mb-2 text-xs text-white-dark dark:text-gray-500">User registrations up 2% this week, with a spike in 18-25 age group.</div>
                                        </div>
                                    ...
                                    <div className="group relative flex items-center py-1.5">
                                        ...
                                        <div>
                                            <div className="flex-1">Performance Boost:</div>
                                            <div className="mb-2 text-xs text-white-dark dark:text-gray-500">System update on 21/01/2024 improved page load speeds by 30%.</div>
                                        </div>
                                    ...
                                    <div className="group relative flex items-center py-1.5">
                                        ...
                                        <div>
                                            <div className="flex-1">Tag Trends:</div>
                                            <div className="mb-2 text-xs text-white-dark dark:text-gray-500">Wellness and productivity identified as top tags in user posts this month.</div>
                                        </div>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                            ...
                                            <td className="text-primary">Pakistani</td>
                                            <td>UAE</td>
                                            <td>1-1-2000</td>
                                            <td>
                                                <span className="badge bg-red-500 shadow-md dark:group-hover:bg-transparent">Deactivated</span>
                                            </td>
                                        </tr>
                                        <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                            ...
                                            <td className="text-info">Somalia</td>
                                            <td>PAK</td>
                                            <td>1-1-2000</td>
                                            <td>
                                                <span className="badge bg-secondary shadow-md dark:group-hover:bg-transparent">Verified</span>
                                            </td>
                                        </tr>
                                        <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                            <td className="text-black dark:text-white">
                                            ...
                                            <td className="text-warning">American</td>
                                            <td>INDIA</td>
                                            <td>1-1-2000</td>
                                            <td>
                                        ...
                                        <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                            ...
                                            <td className="text-danger">Indian</td>
                                            <td>UK</td>
                                            <td>1-1-2000</td>
                                            <td>
                                                <span className="badge bg-secondary shadow-md dark:group-hover:bg-transparent">Verified</span>
                                        ...
                                        <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                            ...
                                            <td className="text-secondary">Bengali</td>
                                            <td>USA</td>
                                            <td>1-1-2000</td>
                                            <td>
                                                <span className="badge bg-success shadow-md dark:group-hover:bg-transparent">Active</span>
                                ...
                                <table>
                                    <thead>
                                        <tr className="border-b-0">
                                            <th className="ltr:rounded-l-md rtl:rounded-r-md">Tags</th>
                                            <th>Tags Used</th>
                                            <th>Entities Added</th>
                                    ...
                                    <tbody>
                                            ...
                                            <td className="min-w-[150px] text-black dark:text-white">
                                                <div className="flex">
                                                    <p className="whitespace-nowrap">
                                                        <span className="block text-primary">#Calm</span>
                                                    </p>
                                                </div>
                                            </td>
                                            <td>168</td>
                                        ...
                                        <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                            <td className="text-black dark:text-white">
                                                <div className="flex">
                                                    <p className="whitespace-nowrap">
                                                        <span className="block  text-warning">#Pure</span>
                                                    </p>
                                                </div>
                                            </td>
                                            <td>126</td>
                                        ...
                                        <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                            <td className="text-black dark:text-white">
                                                <div className="flex">
                                                    <p className="whitespace-nowrap">
                                                        <span className="block  text-danger">#Care</span>
                                                    </p>
                                                </div>
                                            </td>
                                            <td>56</td>
                                        ...
                                        <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                            <td className="text-black dark:text-white">
                                                <div className="flex">
                                                    <p className="whitespace-nowrap">
                                                        <span className="block  text-primary">#Diversity</span>
                                                    </p>
                                                </div>
                                            </td>
                                            <td>110</td>
                                        ...
                                        <tr className="group text-white-dark hover:text-black dark:hover:text-white-light/90">
                                            <td className="text-black dark:text-white">
                                                <div className="flex">
                                                    <p className="whitespace-nowrap">
                                                        <span className="block  text-primary">#love</span>
                                                    </p>
                                                </div>
                                            </td>
                                            <td>56</td>
